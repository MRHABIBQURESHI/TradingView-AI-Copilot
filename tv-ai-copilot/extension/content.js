...
const BACKEND_URL = "https://trading-view-ai-copilot.vercel.app".replace(/\/+$/, "");
...
async function refresh() {
  ...
  try {
    ...
    body.innerHTML = `<div class="tvac-error">Backend error: ${err.message}<br><small>URL: ${BACKEND_URL}</small><br>Check backend status / CORS settings.</div>`;
  }
}
